...
class UpdateAuctionScreen extends StatefulWidget {
  static const String id = '/updateAuctionScreen';

  final AuctionModel auction;

  const UpdateAuctionScreen({super.key, required this.auction});
...
class _UpdateAuctionScreenState extends State<UpdateAuctionScreen> {
  ...
  late TextEditingController _startPriceCtrl;
  ...
  void initState() {
    ...
    _titleCtrl = TextEditingController(text: widget.auction.title.toString());
    _startPriceCtrl = TextEditingController(
      text: widget.auction.startingPrice.toString(),
    );
    _minBidIncrCtrl = TextEditingController(
      text: widget.auction.minimumBidIncrement.toString(),
    );
    _reservePriceCtrl = TextEditingController(
      text: widget.auction.reservePrice?.toString() ?? '',
    );
    _startDate = widget.auction.startDate;
    _endDate = widget.auction.endDate;
  }
  ...
  String? _reservePriceValidator(String? val) {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                _buildSectionHeader(Icons.title, 'Auction Details'),
                ...
                CustomTextFormField(
                  ...
                  label: 'Reserve Price (EGP) - Optional',
                  icon: Icons.shield_outlined,
                  validator: _reservePriceValidator,
                  fillColor: Colors.white,
                  keyboardType: const TextInputType.numberWithOptions(
                    decimal: true,
                  ),
